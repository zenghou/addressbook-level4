...
public class EditCommand extends UndoableCommand {
    ...
    private static Person createEditedPerson(ReadOnlyPerson personToEdit,
        ...
        Person person = new Person(updatedName, updatedPhone, updatedEmail, updatedAddress, updatedBirthday,
            updatedFacebook, updatedTags);

        person.setRemark(updatedRemark);
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(this.name, this.phone, this.email, this.address, this.birthday,
                    this.remark, this.facebook, this.tags);
        }
