...
include::docs/UserGuide.adoc[tag=remark]
...
include::docs/DeveloperGuide.adoc[tag=remark]
...
include::docs/UserGuide.adoc[tag=search]
...
include::docs/DeveloperGuide.adoc[tag=search]
...
include::docs/UserGuide.adoc[tag=login]
...
include::docs/DeveloperGuide.adoc[tag=login]
...
include::docs/DeveloperGuide.adoc[tag=facebookProfilePicture]
