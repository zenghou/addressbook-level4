...
|`* * *` |user |execute commands interactively |I don't need to remember all the commands

|`* * *` |user |open a save file in other directory |I can have multiple addressbooks and share with other users
...
|`* *` |user |edit their details without inputting a long String |I can conveniently edit a person without having to include tags every time
