...
|`* * *` |user |message/email/call my contacts in the list |I do not have to copy/paste/manually enter their details
...
|`* * *` |user |be warned before deleting/ clearing contact |I won't accidentally delete a person
...
|`* * *` |user |sort according to tags/social groups/name/dob |I can conveniently look out for specific tags/identify categories

|`* * *` |user |create a password to hide all the protected field |only I can access the protected field

|`* * *` |user with sensitive data|log in to access the addressbook |only I can access the addressbook
...
|`* * *` |user |see all the names in my contact without the details |I can view a compact list of names on my addressbook
...
|`* *` |user |view my contact's social media profiles |I can easily connect with them if I have not already done so
...
|`* *` |user |edit their details without inputting a long String |I can conveniently edit a person without having to include tags everytime
...
|`* *` |user |share a contact with another user |I can easily share with a click of a button and avoid manual sharing

|`* *` |user |change the color background of my addressbook |I can change the appearance of my UI

|`* *` |user |export my contact details |I can print out the contact document
