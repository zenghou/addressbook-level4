...
Before the user is logged in, the user would not be able to execute any commands. In this version, the user is still able to view the loaded list of contacts. In V1.4, the addressbook will not be loaded until the user is logged in.
